...
document.addEventListener("click", outsideClick);
 ...
 var crossStringClick = function (elem) {
    var target = elem;
    var parentWithActiveClass = findClosestParentWithClass(target, 'active');
...
var findClosestParentWithClass = function (element, className) {
...
(function () {
    ...
    xhr.open("GET", "/data/v1/json/trending", true);
